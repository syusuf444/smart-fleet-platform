...
public static class WebApplicationExtensions
{
    public static WebApplication MigrateAndSeedDatabase(this WebApplication app)
    {
        ...
        try
        {
            ...
            FleetDbSeeder.Seed(context);
        }
        catch (Exception ex)
        {
            logger.LogError(ex, "Failed to migrate or seed the FleetService database.");
            throw;
        }
    ...
    private static void EnsureDatabaseExists(FleetDbContext context)
    {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            throw new InvalidOperationException(
                "FleetService database connection string is missing.");
        }
        ...
        {
            throw new InvalidOperationException(
                "FleetService database name is missing from the connection string.");
        }
